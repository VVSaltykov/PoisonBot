    ...
    public class UserService
    {
        ...
        public static async Task PlaceUserOrder(long chatId, TelegramBotClient client, CallbackQueryEventArgs e)
        {
            ...
            await client.EditMessageTextAsync(chatId, message.MessageId,
                "Выберите тип доставки:\r\n\r\nСтандартный 🚛: доставка автотранспортом, занимает 12-21 дней.\r\nУскоренная ✈️: доставка самолетом, занимает 5-11 дней.\r\nВы можете выбрать подходящий для вас тип доставки в зависимости от срочности получения товара. Если вам необходима быстрая доставка, рекомендуется выбрать ускоренную доставку.\r\n" +
                "Комиссия при заказе 1 позиции составляет 900 рублей. \r\n\r\nПри заказе от 2-х позиций комиссия снижается до 500 рублей за каждую позицию. \r\n\r\nЕсли вы заказываете от 3-х позиций, комиссия составляет 450 рублей за каждую позицию. \r\n\r\nИ если вы заказываете оптом от 10 позиций, комиссия снижается до 300 рублей за каждую позицию. \r\n\r\nАктуальный курс вы можете уточнить в меню бота. 🔄",
